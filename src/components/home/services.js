    ...
    <section className="services">
      <div className="services-main">
        <div className="services-heading ">
          <h1 className='services-common-heading'>Our Service</h1>
        </div>
        ...
        <div className="services-right">
          <h4>service</h4>
           <h1 className='services-common-heading'>Flower Subcriptions</h1>
        ...
        <h4>service</h4>
           <h1 className='services-common-heading'>Wedding & Event Decor</h1>
           <p>Experience the convenience and savings of regular flower deliveries with our flexible subscription service - up to 30% more profitable than one-time purchases.</p>
